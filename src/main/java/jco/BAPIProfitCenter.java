...
public class BAPIProfitCenter {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String DESTINATION_NAME1 = "BAPI_PROFITCENTER_GETDETAIL";
            ...
            JCoDestination destination = JCoDestinationManager.getDestination("BAPI_PROFITCENTER_GETDETAIL");
            destination.ping();
            JCoFunction function = destination.getRepository().getFunction("BAPI_PROFITCENTER_GETDETAIL");
            JCoParameterList importParameterList = function.getImportParameterList();
            importParameterList.setValue("CONTROLLINGAREA","UA01");
            importParameterList.setValue("DATE","2021-08-27");
            importParameterList.setValue("PROFITCENTER","SAP-DUMMY");
