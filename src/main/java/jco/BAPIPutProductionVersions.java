...
public class BAPIPutProductionVersions {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            JCoTable materialTable = function.getTableParameterList().getTable("IT_MKAL_U");
            materialTable.appendRow();
            materialTable.setValue("MANDT", "201");
            materialTable.setValue("MATNR", "15");
            materialTable.setValue("WERKS", "US03");
            materialTable.setValue("VERID", "PV03");
            materialTable.setValue("BDATU", "2021-01-02");
            materialTable.setValue("ADATU", "2021-01-02");
            materialTable.setValue("STLAL", "7");
            ...
            Object vendorRa = function.getTableParameterList().getTable("IT_MKAL_U").getValue("MANDT");
//            String vendorRa = function.getTableParameterList().getTable("IT_MKAL_U").toXML();
